<?php
	...
	$JIT_PSlider_Effects=$wpdb->get_results($wpdb->prepare("SELECT * FROM $table_name4 WHERE id>%d",0));
?>
<form method='POST'>
	...
	<img id="PSlider_Effec8" src="<?php echo plugins_url('/Images/Photo_Carousel.png',__FILE__);?>">
</form>