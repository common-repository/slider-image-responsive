...
Tags: amazing slider, slider, juna slider, Full Width Slider, different size slider, vertical thumbnail slider, horizontal thumbnail slider, thumbnail slider, 3D Slider, Photo Carousel, image slider, wordpress slider admin slider popup slider lightbox
...
New Revolutionary Image slider from Juna IT. This slider is different from all of its charm. In WordPress image sliders Our slider gives you many useful functions.
...
8 ways to demonstrate images will make you satisfy with the look of your slider. Among the views you can find.
...
> * [ Photo Carousel - Demo Version](http://juna-it.com/index.php/photo-slider-carousel-slider-image-responsive)

General Options are available for commercial version users. Here are 8 views (Juna-IT, full width, different size, vertical thumbnail, horizontal thumbnail, thumbnail, 3D slider, phoro carousel), which customization can be done from general options. Customize your slider according to your website, it gives you opportunities to change ratings styles, pagination styles, load more styles for your slider.
...
Beyond the features mentioned above, there are lots of other WordPress slider image responsive features inside of the plugin. You gain the benefit of an intuitive user interface that makes slider management easy, simple to understand options, and a plethora of hooks and filters to manipulate the slider output.

### Fully Responsive 
Plugin can be used on different mobile devised as it ’s flexible for any screen size. As a very important feature - responsiveness is on title and image.
...
Soliloquy is the best choice for a WordPress slider image responsive plugin because it is fast, extremely intuitive and super easy to use. You can get your slider going in just a matter of seconds. In fact, take a look at how easy it is to create a Juna-IT plugin.

### Cross Browser, All Browsers Supported ( Pro )
slider image responsivePro Plugin is all browsers are supported (IE 6+, Firefox 2+, Chrome 3+, Safari 3+, Opera 10+, iOS Safari, Opera Mobile, Android Browser, iPhone, iPad, Mac, Windows Surface etc.).
...
### Shortcode
**Shortcode:** Using [Juna-Photo-Slider id="N"] shortcode, you can publish plugin in any Page or Post in your WordPress sites. Copy & paste the shortcode directly into any WordPress post or page.

**Templete Include:** Using <?php echo do_shortcode("[Juna-Photo-Slider id="N"]");?> shortcode, you can publish slider in any Page or Post in your WordPress sites. Copy & paste this code into a template file to include the slideshow within your theme.

### Update
We constantly do updates, if you are a pro version user, please write our support team to receive the updated version of slider image responsive plugin. Free user may download the latest version from WordPress.use the slider has to download the slider package.
...
[* Demo Version 2 Full Width](http://juna-it.com/index.php/full-width-slider-demo)

Full Width Slider is a elegant and flexible way to making creative designs specially while you designing websites for photography, image, modeling, fashion, beauty etc. The slider stretches the entire width of the screen, allowing it to take up the maximum amount of space. Clicking on an arrow allows the user to switch to the previous or next slide. It gives an incredible look to any website. If you are creating a music site, photography site, beauty, fashion or personal for a model then you may need to add a fullscreen background slider to make your design more awesome. Full Width makes it possible to use many heavier images as full screen background slider or image, while minimizing their influence on load times. You are not only allowed to add images also can add caption in each slider.

[* Demo Version 3 Different Size](http://juna-it.com/index.php/different-size-slider/)

Different Size It is equipped with various unique, touch-enabled slide transitions. It gives the option of selecting the slider layout and performs well on almost all browsers and devices. It also offers animated content. It is fully responsive with touch control. It offers uploading images (PNG, JPG, JPEG, GIF and etc.). This is very good to make a slider of different images. You can specify the duration of each slide.

[* Demo Version 4 Vertical Thumbnail](http://juna-it.com/index.php/slider-vertical-thumbnail-slider-gallery)

Fantastic vertical image thumbnail plugin which will allow you to display your images in a nice way. Is perfect for showcasing your portfolios or whatever you want. Very simple but useful. You can display your featured items with this thumbnails slider.

[* Demo Version 5 Horizontal Thumbnail](http://juna-it.com/index.php/slider-horizontal-thumbnail-slider-gallery/)

Horizontal thumbnail is now a must have feature in all businesses or any website template. All code here is free to use and you may alter it according to your needs if you are already a developer. You can check the demo page to find all options of this version before installing it on your web site. A easy tutorial is setup to create a responsive image slider with thumbnail . Horizontal thumbnail is well adapted to modern devices.

[* Demo Version 6 Thumbnail](http://juna-it.com/index.php/slider-thumbnail-slider-gallery/)

Slide is a simple but pretty nice plugin for creating fully customizable image slider with thumbnails and smooth transition animations. Slideshow allows you to infinitely navigate through a group of images by clicking on the thumbnails or arrows navigation.

[* Demo Version 7 3D Image](http://juna-it.com/index.php/3d-slider-image-responsive/)

A simple 3D slider. It supports all major browsers including IE8,9 with best effort. 3D version is a powerful jQuery plugin that allows you to arrange a set of images in a carousel layout. With 3D transforms, we can make simple elements more interesting by setting them into three dimensional space.

[* Demo Version 8 Photo Carousel](http://juna-it.com/index.php/photo-slider-carousel-slider-image-responsive/)

Photo Carousel is a touch-enabled, responsive and customizable image, carousel and lightbox, optimized for both mobile and desktop web browsers. This slideshow is clean and minimalist which makes it an appropriate choice for websites with a spare design. It also works well for webpages with a more embellished style looking to add a slider without overcrowding the page or a visitors senses. Auto center the images as you resize the window. Jumping to a specific image within the slider is easy, simply click image on and that main photo will appear on the slider.
...
> #### Photo Carousel Demo Version
>[* Photo Carousel - Demo Version - 1](http://juna-it.com/index.php/photo-slider-carousel-slider-image-responsive/)
>[* Photo Carousel - Demo Version - 2](http://juna-it.com/index.php/photo-slider-carousel-slider-image-responsive-2/)
>[* Photo Carousel - Demo Version - 3](http://juna-it.com/index.php/photo-slider-carousel-slider-image-responsive-3/)
>[* Photo Carousel - Demo Version - 4](http://juna-it.com/index.php/photo-slider-carousel-slider-image-responsive-4/)
>[* Photo Carousel - Demo Version - 5](http://juna-it.com/index.php/photo-slider-carousel-slider-image-responsive-5/)
...
> * Copy the "gallery-video-responsive" folder into the /wp-content/plugins directory of your WordPress installation
> * Login to your website and go to the Plugins section of your admin panel
> * Look for slider image responsive plugin and click Activate
>
> ### Or Mac Users
>
> * Go to your Downloads folder and locate the folder with the Juna-IT-slider-image-responsiveplugin
...
> * Click "Activate Plugin" button for activating the slider image responsive plugin

**That's all, now you can build your plugin. If any problem occurs, contact us at [junait.com@gmail.com](mailto:junait.com@gmail.com).**
...
Slider Image Responsive plugin Pro users can get update versions contacting us by [junait.com@gmail.com.] (mailto:junait.com@gmail.com). Free version users will find update notification in their wordPress admin panel
...
11. [WordPress Plugin](https://wordpress.org/plugins/slider-image-responsive/) - Admin Page
12. [WordPress Plugin](https://wordpress.org/plugins/slider-image-responsive/) - Admin Page: New  Image
22. [WordPress Plugin](https://wordpress.org/plugins/slider-image-responsive/) - General Option
...
= Juna-IT, List Version 1.1.15 =
* Bug fixed in 3D Slider version

= Juna-IT, List Version 1.1.14 =
* Bug fixed

= Juna-IT, List Version 1.1.13 =
* Front end bug fixed

= Juna-IT, List Version 1.1.12 =
* Added new Gallery Slider type: 'Photo Carousel'
...
* Shortcode (Template Include) - Here you will see shortcode which you can copy and Paste[Juna-Photo-Slider id="N"] where you want to see your plugin.
...
**Select Type:** From this 8 type you can choose only one. Select the option which is more matches your website. Clicking on select menu you will choose your version.
...
* **Title** - Important possibility to add title to each image in the gallery. The Image title can be seen not in all views, but some of them have a place for it. Image Slider plugin accomplished with title looks rich and perfect.

* **Add images from Media Library** - You can select images to use within the slider which are currently uploaded to your Media Library by clicking on those and pressing " Insert into post " button. In addition, you can upload new files, navigating to the Upload Files tab on the left. Then press Select Files button, choose the image and press Insert button. This way the image will be added to the slider. **Add Image URL** - You can also add images providing the absolute link to it. Press Add Image URL, provide the link and press Add button. This will be useful for adding images to the slider without the need of downloading those and uploading again. **Add Image** - In addition to images, you can instead use images within the slider from web site URL. You should click on the Add button, provide the link to and press Add button. The image associated with the web site image will be automatically displayed as a image slider. **Remove** - You can use button to remove
...
[**Different Size**](http://juna-it.com/index.php/different-size-slider/)
...
**General Options**
* **Auto Play** - Select whether to see the slideshow or not.
* **Change Speed** - Select change speed of slideshow.
* **Slide Spacing** - 
...
**Select Type:** From this * type you can choose only one. Select the option which is more matches your website. Clicking on select menu you will choose your version.
...
* **Show Title** - Choose whether to show title or not.
* **Title Font Size** - Define the font size for the image title.
* **Font Family** - Specify the font family for the text in the main slider.
* **Color** - Select color tune it with your photo
* **Box-Shadow Color** - Click if you'd like to have shadows color in the box.

**Slider Option**

* **Backgroun Color** - Select the background colour for slideshow. The area where will show the of the main photo.
* **Border Width** - Set the width of borders
* **Border Style** - Select 4 different types of border - Solid, Dotted, Dashed, Double.
* **Border Color** - Choose border color.
* **Border Radius** This option is for the roundness of your slider border. Define main border radius of slider, and you can change it anytime you like.
* **Box Shadow Color** - Click if you'd like to have shadows in the box. Choose box shadow color.
* **Image Width** - Define the image width for the photo thumbnail.
* **Image Height** - Define the image height for the photo thumbnail.
* **Image Border Width** - Select border width for main photo.
* **Image Border Color** - Select border color for main image.
* **Image Border Style** Define main border style of image, and you can change it anytime you like. Select 4 different types of border - Solid, Dotted, Dashed, Double.
* **Image Border Radius** - Define the border radius of the main photo.
* **Show Icon** - You can define to appear the icons or not in slideshow.
* **Icon Color** - Select the slider icons color.
* **Icon Opacity** - Define the level of opacity for the photo, providing its percentage.
* **Icon Size** - Alter the size of the icon regardless of the container (px).
* **Icon Background Color** - Specify preferable background color of the icons.

**Choose Icons for Slider

* **Assign a default icon in the slideshow** - You can select icons from our 9 different beautifully designed sets.

**Thumbnail Navigator Option** - 
* **Background Color** - Select the background colour for thumbnail. The area where will show the of the photo.
* **Border Style** - Select 4 different types of border - Solid, Dotted, Dashed, Double.
* **Border Radius** This option is for the roundness of your thumbnail slider border. Define border radius of slider, and you can change it anytime you like.
* **Image Width** - Define the photo width for the thumbnail.
* **Image Height** - Define the photo heigth for the thumbnail.
* **Image Border Color** - Select border color for the photo.
* **Image Border Hover Color** - Select background color for border when hovered.
* **Icon Size** - Define some icon size for the thumbnail.
* **Border Width** - Set the width of thumbnail borders
* **Border Color** - Choose border color.
* **Box Shadow Color** - Click if you'd like to have shadows in the box. Choose box shadow color.
* **Image Border Current color** - The thumbnail for the currently displayed image will have a border color. You can set its color.
* **Image Opacity** - Define the level of opacity for the photo slider, providing its percentage.
* **Icon Color** - Select the thumbnail slider icons color.

**Choose Icons for Thumbnail
