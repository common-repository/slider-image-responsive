...
<script type="text/javascript">
	...
	function Edit_JITPSlider_Effect(Edited_ID)
	{
		...
		{
			jQuery('#JIT_PSlider_EN').val('Photo Carousel');
			jQuery('#JIT_PSlider_ET').val('Photo Carousel');

			setTimeout(function(){
				jQuery('.JIT_PSlider_Submenu1_Div1').fadeIn();
				jQuery('.JIT_PSlider_Main_Fieldset1').fadeIn();
				jQuery('#PSlider_Effec8').fadeIn();
			},500)
		}
	}
	function JIT_PSlider_ET_Changed()
	{
		...
		setTimeout(function(){
			...
			else if(jQuery('#JIT_PSlider_ET').val()=='Photo Carousel')
			{
				jQuery('#PSlider_Effec8').fadeIn();
			}
		},500)	
